...
replay only: on the rectangle `[1999/2000,2001/2000]^2` minus C,
`tools/rn_side24_spatial_check.py` replays a four-cell split with integral
upper below `6e-12`, which is not a claim of that note, and the rest of the
near annulus `0.1 <= |y| <= 5` is not covered. SIDE24 source-of-truth carriers
