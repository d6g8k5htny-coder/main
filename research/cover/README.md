...
Controls 33 and 34 in `tests/test_cover.py`. Control 33 was confirmed to FAIL
against a copy of the package with the guard deleted; control 34 rebuilds the
