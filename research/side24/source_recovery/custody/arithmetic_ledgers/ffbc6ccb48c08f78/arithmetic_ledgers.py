...
ck((cone_adverse < F(1, 3)), "check")
ck((strip_adverse < F(9, 10)), "check")
ck((bracket == F(9869, 16777216) and bracket < F(1, 768)), "check")
ck((F(49, 192) - F(1, 768) == F(65, 256) and F(65, 256) > F(1, 4)), "check")
...
ck((unnorm == F(5, 10**187) and rel == F(5, 10**185)), "check")
...
ck(math.log10(1e-180/5e-185) > 4, "margin to the theorem-level 1e-180")
