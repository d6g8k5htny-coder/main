...
def test_33_NEGATIVE_CONTROL_outside_cannot_carry_a_nonzero_residual():
    """CONTROL 33. The ledger must refuse a residual it is about to discard.
...
def test_34_NEGATIVE_CONTROL_the_outside_guard_is_load_bearing():
    """CONTROL 34. Control 33 must fail if the guard is removed.
    ...
    and the run still ``certified=True`` — so that control 33 is known to be
