...
**Architecture:** `meta-framework` owns normative JSON contract schemas; `trial` owns executable conformance tests and synthetic failure fixtures. Production packages remain runtime-independent and this plan has no scientific promotion authority.
...
- Create: `trial/federation/contract_validation.py`
- Create: `trial/federation/test_source_contracts.py`
...
- [ ] Run `python -B -S -m unittest -v federation.test_source_contracts` and observe RED.
...
- Modify: `trial/federation/contract_validation.py`
- Modify: `trial/federation/test_source_contracts.py`
...
**Files:**
- Create: `trial/federation/architecture_conformance.py`
- Create: `trial/federation/test_architecture_conformance.py`
...
### Task 4: Hosted CI and mutation controls

**Files:**
- Modify existing trial federation workflow, or create one only if none exists.
- Modify federation tests.
