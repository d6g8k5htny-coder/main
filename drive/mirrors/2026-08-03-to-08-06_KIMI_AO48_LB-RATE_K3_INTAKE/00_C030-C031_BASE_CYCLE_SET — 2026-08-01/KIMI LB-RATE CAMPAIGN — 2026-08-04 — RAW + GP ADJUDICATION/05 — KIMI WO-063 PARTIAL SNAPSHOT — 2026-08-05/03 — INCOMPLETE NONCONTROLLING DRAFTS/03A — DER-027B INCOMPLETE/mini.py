...
def cross_validate():
    ...
    picks = [keys[i] for i in range(0, len(keys), step)][:3] if keys else []
    if not picks:
...
REGIONS = [
    ...
    ('C',  Fr(-9, 10), Fr(-4, 5), Fr(1, 10), Fr(1, 5), Fr(1, 20), None),
    ('M',  Fr(-3, 2), Fr(-1, 10), Fr(0), Fr(7, 10), Fr(1, 10),
     (Fr(-9, 10), Fr(-2, 5), Fr(1, 10), Fr(1, 2))),
    ('O',  Fr(-2), Fr(1, 5), Fr(0), Fr(1), Fr(1, 5),
...
def main():
    ...
    aux = sweep_region('C2', Fr(-9, 10), Fr(-4, 5), Fr(1, 10), Fr(1, 5), Fr(1, 10), None)
    Q2 = region_b3(aux)
